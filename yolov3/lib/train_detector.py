...
class Detector():
    ...
    def set_fixed_params(self):
        ...
        Returns:
            None
        '''
        self.system_dict["fixed_params"]["wdir"] = '/content/drive/My Drive/Datasets/P_Reports/Results/weights' + os.sep  
        ...
        self.system_dict["fixed_params"]["results_file"] = '/content/drive/My Drive/Datasets/P_Reports/Results/results.txt'
    ...
    def set_hyperparams(self, optimizer="sgd", lr=0.00579, multi_scale=False, evolve=False, num_generations=2, 
        ...
        self.system_dict["params"]["weights"] = '/content/drive/My Drive/Datasets/P_Reports/best.pt';
    ...
    def start_training(self):
        ...
        for epoch in range(self.system_dict["local"]["start_epoch"], self.system_dict["params"]["epochs"]):  # epoch ------------------------------
            ...
            print('\n Learning Rate: %f' % (self.system_dict["fixed_params"]["hyp"]['lr0']))
        ...
        if(self.system_dict["dataset"]["val"]["status"]):
            ...
            if len(n):
                ...
                os.rename('/content/drive/My Drive/Datasets/P_Reports/Results/results.txt', fresults)
